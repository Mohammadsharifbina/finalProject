...
const check = function () {
  ...
  const math = Number(document.querySelector(".maths-cr").value);
  const computer = Number(document.querySelector(".computer-cr").value);
  const engl = Number(document.querySelector(".english-cr").value);
  const urd = Number(document.querySelector(".urdu-cr").value);
  const stat = Number(document.querySelector(".stats-cr").value);
  const stu = Number(document.querySelector(".study-cr").value);
  ...
  // const credit = Number(document.querySelector(".cr").value);
  ...
  const marks = (maths*math)+ (comp*computer)+(stats*stat)+(english*engl)+(urdu*urd)+(study*stu);
  document.getElementById("obtainedMarks").innerHTML = marks;

  const percent = (marks * 100) / 2200;
