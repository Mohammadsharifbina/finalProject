...
<div class="main-content">
	@include('project.dashboard.header')
...
<script>
    ...
    let serachData=document.getElementById("mySearch").value.toUpperCase();
      ...
      for(var u=0; u<tr.length;u++){
        ...
        if(td){
         let myValue=td.textContent || td.innerHTML;
            ...
            if(myValue.toUpperCase().indexOf(serachData) > -1){
                 tr[u].style.display="";
            }
            else{

              tr[u].style.display="none";
